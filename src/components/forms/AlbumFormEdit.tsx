import { BaseSyntheticEvent, ReactElement, Ref, useEffect, useRef, useState } from "react";
...
export default function AlbumFormEdit(props: AlbumFormEditProps): ReactElement {
    ...
    const { isLoading, isError, isSuccess, message } = useSelector((state: RootState) => {
        return state.album
    });
    ...
    const { title, file, year, genre, fileName } = formData;

    useEffect(() => {

    }, [title, file, formData, year, genre])
        ...
        <Div>
            <Container>
                ...
                <Form method="POST"
                    ...
                    <Title name="genre" type="text" placeholder="Genre"></Title>
                    <Title name="year" type="number" placeholder="Year"></Title>
